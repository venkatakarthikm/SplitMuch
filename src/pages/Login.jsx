        ...
        <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-large border border-primary-100/50 p-8 md:p-10">
          <div className="text-center mb-8">
            <motion.div
              ...
              className="inline-flex items-center justify-center w-20 h-20  from-primary-500 to-primary-400 rounded-2xl shadow-large shadow-primary-500/40 mb-6"
            >
              <img
                src="/splitmuch.png"
                alt="SplitMuch Logo"
            ...
            <p className="mt-2 text-primary-600/70">
