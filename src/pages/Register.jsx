    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
        ...
        >
          ...
          <h2 className="text-3xl font-display font-bold text-primary-800 mb-4">Verify Your Email</h2>
          <p className="text-primary-600/80 mb-8 leading-relaxed">
            A verification link has been sent to <br />
            <span className="font-bold text-primary-500">{formData.email}</span>. <br />
        ...
        <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-large border border-primary-100/50 p-8">
          <div className="text-center mb-8">
            <motion.div
              ...
              className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-primary-500 to-primary-400 rounded-2xl shadow-large shadow-primary-500/40 mb-4"
            >
              <span className="text-3xl">💰</span>
            </motion.div>
            <h2 className="text-2xl font-display font-bold text-primary-800">Create Account</h2>
            <p className="mt-2 text-primary-600/70 text-sm">Join us to start splitting expenses</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="username" className="block text-sm font-semibold text-primary-700 mb-1.5">
                Username *
              </label>
              <motion.input
            ...
            <div>
              <label htmlFor="phone" className="block text-sm font-semibold text-primary-700 mb-1.5">
                Phone Number *
              </label>
              <motion.input
                whileFocus={{ scale: 1.01 }}
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-semibold text-primary-700 mb-1.5">
                Confirm Password *
              </label>
              <motion.input
                whileFocus={{ scale: 1.01 }}
